...
export default function EnrollmentsIndex() {
  ...
  // Fetch units for selected class and semester
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Posting to URL: /admin/enrollments');
    ...
    if (formData.unit_ids.length === 0) {
      console.log('Validation failed: No units selected');
            ...
            <div className="p-8">
              {enrollments.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500">Get started by creating a new enrollment.</p>
                  {can.create && (
                    <button
                      onClick={handleCreateEnrollment}
